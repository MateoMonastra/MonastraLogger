package com.monastra.pluginlogger;
...
public class MonastraLogger {
    private static final MonastraLogger instance = new MonastraLogger();
    private static final String LOGTAG = "Log -> ";
    private String fileName = "Monastra_Log.txt";
    private static Activity unityActivity;

    AlertDialog.Builder builder;

    public static MonastraLogger getInstance(){return instance;}
    private String allLogs = "";

    private MonastraLogger()
    {
